...
url_weather = "https://api.openweathermap.org/data/2.5/forecast?q={}&units=metric&appid={}".format(location, api_key)
...
#_data = json_data['weather'][0]['']     #temp
#_data = json_data['weather'][0]['']     #temp min
#_data = json_data['weather'][0]['']     #temp max
...
while True:
    ...
    #owm = pyowm.OWM('407e6b87193b0487cc3a40b986372aa2')

    #observation = owm.weather_at_place('Oberderdingen, GER')
