...
#BILDER LADEN:
bilder = []
im01d = pygame.image.load('Images/01d.png')
bilder.append(im01d)
im01n = pygame.image.load('Images/01n.png')
bilder.append(im01n)
im02d = pygame.image.load('Images/02d.png')
bilder.append(im02d)
im02n = pygame.image.load('Images/02n.png')
bilder.append(im02n)
im03d = pygame.image.load('Images/03d.png')
bilder.append(im03d)
im03n = pygame.image.load('Images/03n.png')
bilder.append(im03n)
im04d = pygame.image.load('Images/04d.png')
bilder.append(im04d)
im04n = pygame.image.load('Images/04n.png')
bilder.append(im04n)
im09d = pygame.image.load('Images/09d.png')
bilder.append(im09d)
im10d = pygame.image.load('Images/10d.png')
bilder.append(im10d)
im10n = pygame.image.load('Images/10n.png')
bilder.append(im10n)
im11d = pygame.image.load('Images/11d.png')
bilder.append(im11d)
im11n = pygame.image.load('Images/11n.png')
bilder.append(im11n)
im13d = pygame.image.load('Images/13d.png')
bilder.append(im13d)
im13n = pygame.image.load('Images/13n.png')
bilder.append(im13n)
im50d = pygame.image.load('Images/50d.png')
bilder.append(im50d)
im50n = pygame.image.load('Images/50n.png')
bilder.append(im50n)
...
def show_temp_tage(x,y):
	...
	screen.blit(temp_tag, (x + 600, y + i*50))
        grad3 = font2.render("C" ,True, (150,250,250))
        screen.blit(grad3, (x + 650, y + i*50))
	screen.blit(bilder[bilder_dict[icon_tage[i]]], (x + 700, y + i*50))

def show_messages(x,y):
    for i in range(0, 3):
        message = font1.render("From : " + mess1Val[i], True, (150,250,250))
...
#    show_times(origin[0], origin[1])
    ...
    show_current_temp(origin[0], origin[1])
...
#        show_messages(textX, textY[i])
    ...
    #print(weekday)
    show_Weekday(origin[0], origin[1])
